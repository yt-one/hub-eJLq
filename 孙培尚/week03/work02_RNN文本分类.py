...
class RNNClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        rnn_out, hidden_state = self.rnn(embedded)  # hidden_state: (1, batch, hidden_dim)
        out = self.fc(hidden_state.squeeze(0))  # (batch, hidden_dim) -> (batch, output_dim)
        return out
